    ...
    <section className="courses" id='courses'>
        ...
        <div className="course__title__content">
            <div className="course__title__container">
              ...
              // this svg is the lines beside the Trending Courses title
        ...
        <div className="update_add"> 
          ...
          // this svg is the update icon

            <svg xmlns="http://www.w3.org/2000/svg" width="44" height="45" viewBox="0 0 44 45" onClick={updateCard}>
        ...
        // this is the course adding for , with toggleState and css classes we can trigger the form to be close or open.
