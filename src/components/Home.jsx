    ...
    <section className='home' id='home'>
      ...
      <div className="home__content">
        <div className="home__content__announcement">
          ...
          <div className="home__content__announcement__header__txt">
